...
#     MICRODADOS_ENEM_2023.csv no mesmo diret?rio.	                  
#------------------------------------------------------------------------
...
ENEM_2023 <- read_csv2('MICRODADOS_ENEM_2023.CSV',
                col_select = c(NU_NOTA_CN,
                               NU_NOTA_CH,
                               NU_NOTA_LC,
                               NU_NOTA_MT,
                               NU_NOTA_REDACAO)) %>%
  sample_n(15000) %>%
  drop_na() %>%
  transmute(CN = NU_NOTA_CN / 10,
         CH = NU_NOTA_CH / 10,
         LC = NU_NOTA_LC / 10,
         MT = NU_NOTA_MT / 10,
         REDAÇÃO = NU_NOTA_REDACAO) %>%
  filter(!((CN == 0 & MT == 0) | (CH == 0 & LC == 0 & REDAÇÃO == 0)))

# Removendo as pessoas que faltaram em um dos dias da prova (ou em ambos)
...
#                                             'Estou cursando e concluirei o Ensino M?dio em 2023',
#                                             'Estou cursando e concluirei o Ensino M?dio ap?s 2023',
...
#                                    labels=c('N?o informado','2022', '2021','2020','2019',
...
#labels = c('Azul','Amarela','Cinza','Rosa','Amarela - Ampliada','Amarela - Superampliada','Laranja - Braile',
#           'Laranja - Adaptada Ledor','Verde - Videoprova - Libras','Azul (Reaplica??o)','Amarela (Reaplica??o)',
#           'Cinza (Reaplica??o)','Rosa (Reaplica??o)'))
...
#labels = c('Azul','Amarela','Branca','Rosa','Amarela - Ampliada','Amarela - Superampliada','Laranja - Braile',
#           'Laranja - Adaptada Ledor','Verde - Videoprova - Libras','Azul (Reaplica??o)','Amarela (Reaplica??o)',
#           'Branca (Reaplica??o)','Rosa (Reaplica??o)'))
...
#labels = c('Azul','Amarela','Rosa','Branca','Amarela - Ampliada','Amarela - Superampliada','Laranja - Braile',
#           'Laranja - Adaptada Ledor','Verde - Videoprova - Libras','Azul (Reaplica??o)','Amarela (Reaplica??o)',
#           'Rosa (Reaplica??o)','Branca (Reaplica??o)'))
...
#labels = c('Azul','Amarela','Rosa','Cinza','Amarela - Ampliada','Amarela - Superampliada','Laranja - Braile',
#           'Laranja - Adaptada Ledor','Verde - Videoprova - Libras','Azul (Reaplica??o)','Amarela (Reaplica??o)',
#           'Rosa (Reaplica??o)','Cinza (Reaplica??o)'))
